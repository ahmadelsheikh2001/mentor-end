...
// import Nave from '../.. /components/Globel/Nave/Nave';
// import Header from '../../components/Globel/Header/Header';
                    ...
                    <div className="recent-mentoring">
                        <div className="website-ui">
                            <div className="parent">
                                ...
                                <div className="right">
                                    <button className="btn-gernal btn-new-request">Request</button>
                                    <button className="btn-gernal btn-new-request mt-2">View</button>
                                </div>
                            </div>
                            <div className="buttons-groups mt-3">
                                <div className="btns">
                                    <button className="btn-gernal btn-accept">Certificate</button>
                                    <button className="btn-gernal btn-accept mx-3">Remote</button>
                                    <button className="btn-gernal btn-accept">Open Duration</button>
                                </div>
                                <div className="btns mt-3">
                                    <button className="btn-gernal btn-accept">Paid</button>
                                    <button className="btn-gernal btn-accept ms-3">Might get hired</button>
                                </div>
                            </div>
                        ...
                        <div className="know-some-one-right">
                            <div className="right">
                                ...
                                <div className="email-invite">
                                    ...
                                    <button className="btn-gernal btn-accept btn-invite">Invite</button>
                    ...
                    <div className='req-container'>
                        <div className="front-enf-development">
                            ...
                            <div className="front-enf-development-2">
                                <button className="btn-gernal btn-new-request">Certificate</button>
                                <button className="btn-gernal btn-new-request mx-2">Remote</button>
                            </div>
